...
- `src`: This folder is the main container of all the code inside your application.
  ...
  - `screens`: Folder that contains all your application screens/features.
    - `Screen`: Each screen should be stored inside its folder and inside it a file for its code and a separate one for the styles and tests.
      - `Screen.js`
  - `hooks`: Folder to store any react use custom hook that you have.
  - `@types`: Folder to store any types annotation that you have.
  - `theme`: File to store all the styling concerns related to the application theme.
  - `App.tsx`: Main component that starts your whole app.
  - `index.js`: Entry point of your application as per React-Native standards.
- `assets`: Folder to store any static file, such as images, fonts, etc.
